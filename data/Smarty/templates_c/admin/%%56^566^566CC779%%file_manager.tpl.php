<?php /* Smarty version 2.6.26, created on 2014-07-16 07:35:19
         compiled from contents/file_manager.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'contents/file_manager.tpl', 27, false),array('modifier', 'h', 'contents/file_manager.tpl', 50, false),array('modifier', 'number_format', 'contents/file_manager.tpl', 110, false),array('function', 't', 'contents/file_manager.tpl', 62, false),)), $this); ?>
...
<div id="admin-contents" class="contents-main">
    ...
    <div id="contents-filemanager-right">
        <table class="now_dir">
            <tr>
                <th><?php echo smarty_function_t(array('string' => 'tpl_File upload_01'), $this);?>
</th>
                <td>
...
"<?php endif; ?>><a class="btn-normal" href="javascript:;" onclick="setTreeStatus('tree_status');fnModeSubmit('upload','',''); return false;"><?php echo smarty_function_t(array('string' => 'tpl_Upload_01'), $this);?>
</a>
                </td>
            </tr>
            <tr>
                <th><?php echo smarty_function_t(array('string' => 'tpl_Folder creation_01'), $this);?>
</th>
                <td>
...
<?php endif; ?>"><a class="btn-normal" href="javascript:;" onclick="setTreeStatus('tree_status');fnModeSubmit('create','',''); return false;"><?php echo smarty_function_t(array('string' => 'tpl_Create_01'), $this);?>
</a>
                </td>
            </tr>
        </table>
        ...
        <table class="list">
            <tr>
                ...
                <th><?php echo smarty_function_t(array('string' => 'tpl_Size_01'), $this);?>
</th>
                <th><?php echo smarty_function_t(array('string' => 'tpl_Date of update_01'), $this);?>
</th>
                <th class="edit"><?php echo smarty_function_t(array('string' => 'tpl_Display_01'), $this);?>
</th>
...
img/contents/folder_parent.gif" alt="Folder">&nbsp;..
                    </td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
...
', '#808080');fnModeSubmit('move','',''); return false;"><?php echo smarty_function_t(array('string' => 'tpl_Display_01'), $this);?>
</a>
                        </td>
                    <?php else: ?>
                        <td class="center">
...
');fnSelectFile('<?php echo ((is_array($_tmp=$this->_tpl_vars['id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
', '#808080');fnModeSubmit('view','',''); return false;"><?php echo smarty_function_t(array('string' => 'tpl_Display_01'), $this);?>
</a>
                        </td>
                    <?php endif; ?>
                    <?php if (((is_array($_tmp=$this->_tpl_vars['arrFileList'][$this->_sections['cnt']['index']]['is_dir'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
                    ...
                    <?php else: ?>
                        <td class="center">
                            <a href="javascript:;" onclick="fnSetFormVal('form1', 'select_file', '<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrFileList'][$this->_sections['cnt']['index']]['file_path'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
');fnSelectFile('<?php echo ((is_array($_tmp=$this->_tpl_vars['id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
', '#808080');setTreeStatus('tree_status');fnModeSubmit('download','',''); return false;"><?php echo smarty_function_t(array('string' => 'tpl_Download_01'), $this);?>
</a>
                        </td>
                    <?php endif; ?>
                    <td class="center">
                        <a href="javascript:;" onclick="fnSetFormVal('form1', 'select_file', '<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrFileList'][$this->_sections['cnt']['index']]['file_path'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
');fnSelectFile('<?php echo ((is_array($_tmp=$this->_tpl_vars['id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
', '#808080');setTreeStatus('tree_status');fnModeSubmit('delete','',''); return false;"><?php echo smarty_function_t(array('string' => 'tpl_Remove_01'), $this);?>
</a>
                    </td>
                </tr>
            <?php endfor; endif; ?>
