...
?></div><?php endfor; endif; ?>
    ...
    <div id="products-rank-right">
        ...
        <?php if (count ( ((is_array($_tmp=$this->_tpl_vars['arrProductsList'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) ) > 0): ?>
            ...
            <p class="remark"><?php echo smarty_function_t(array('string' => "tpl_<span class='attention'>T_ARG1 items</span> were found._01",'escape' => 'none','T_ARG1' => ((is_array($_tmp=$this->_tpl_vars['tpl_linemax'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))), $this);?>
</p>
            <div class="pager">
            ...
            <?php if (((is_array($_tmp=@ADMIN_MODE)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '1'): ?>
                <p class="right"><a class="btn-normal" href="javascript:;" onclick="fnModeSubmit('renumber', '', ''); return false;"><?php echo smarty_function_t(array('string' => 'tpl_Reallocation of internal ranking_01'), $this);?>
</a></p>
            <?php endif; ?>
...
?>
                    <tr>
                        <td>
                            <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrProductsList'][$this->_sections['cnt']['index']]['product_code_min'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>

                            <?php if (((is_array($_tmp=$this->_tpl_vars['arrProductsList'][$this->_sections['cnt']['index']]['product_code_min'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ((is_array($_tmp=$this->_tpl_vars['arrProductsList'][$this->_sections['cnt']['index']]['product_code_max'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
                                <br /><?php echo smarty_function_t(array('string' => "-"), $this);?>
 <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrProductsList'][$this->_sections['cnt']['index']]['product_code_max'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
...
">
                        ...
                        <td align="center">
                            ...
                            <?php if (((is_array($_tmp=$this->_tpl_vars['arrProductsList'][$this->_sections['cnt']['index']]['status'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '2'): ?><br /><?php echo smarty_function_t(array('string' => "tpl_(Not disclosed)_01"), $this);?>
<?php endif; ?>
                        </td>
                        <td align="center">
...
<a href="?" onclick="fnModeSubmit('move','product_id', '<?php echo ((is_array($_tmp=$this->_tpl_vars['arrProductsList'][$this->_sections['cnt']['index']]['product_id'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
...
'); return false;"><?php echo smarty_function_t(array('string' => 'tpl_To bottom_01'), $this);?>
        ...
        <?php else: ?>
            <p><?php echo smarty_function_t(array('string' => "tpl_Select a category._01"), $this);?>
</p>
        <?php endif; ?>
    </div>
    <!--▲画面右-->
