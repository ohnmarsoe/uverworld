<?php /* Smarty version 2.6.26, created on 2014-07-29 09:00:32
...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/Applications/MAMP/htdocs/uverworld/html/../data/Smarty/templates/default_en-US/frontparts/bloc/search_products.tpl', 26, false),array('modifier', 'h', '/Applications/MAMP/htdocs/uverworld/html/../data/Smarty/templates/default_en-US/frontparts/bloc/search_products.tpl', 44, false),array('function', 'html_options', '/Applications/MAMP/htdocs/uverworld/html/../data/Smarty/templates/default_en-US/frontparts/bloc/search_products.tpl', 38, false),)), $this); ?>
...
" />
            ...
            <dl class="formlist">
                ...
                <?php endif; ?>
                 <span class="search-input-text"><input type="text" name="name" class="plchldr" maxlength="50" value="<?php echo ((is_array($_tmp=((is_array($_tmp=$_GET['name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" /> </span>
